...
namespace UserModule.Models
{
    public class MyEncodingInfo
    {
        ...
        public string DisplayName { get; set; } = "Automatic"; //todo: localize TranslationProvider.Translate("settings-encode-automatic") as string;
        ...
        {
            return obj is MyEncodingInfo other && other.Name == Name;
        }
